...
// Index Page.
//
controllers.connections.index = ['$scope', '$http', '$location', 'Broadcaster', 'Rest', 'Idbstore', function($scope, $http, $location, Broadcaster, Rest, Idbstore)
{
	$scope.connections = [];
...
// Evernote - Settings.
//
controllers.connections.evernote_settings = ['$scope', '$http', '$location', 'Broadcaster', 'Rest', 'Idbstore', function($scope, $http, $location, Broadcaster, Rest, Idbstore)
{
