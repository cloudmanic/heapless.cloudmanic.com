...
<head>
	...
	<style type="text/css" media="php-parser">
		...
		.link { color:#0da8e8; text-decoration:none; }
		...
		<td align="center" valign="top">
			<table width="600" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td class="text">
												<div class="h3">Welcome Harnods,</div>
												<br height="15" />
												Thanks for signing up with HeapLess. To get started you can:
												<br height="15" />
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td class="img" width="20"></td>
														<td class="text-2">
															1. Edit your Account Settings here <a href="https://www.heapless.com/account/settings/" target="_blank" class="link">https://www.heapless.com/account/settings/</a>
															<br height="10" />
														</td>
													</tr>
													<tr>
														<td class="img" width="20"></td>
														<td class="text-2">
															2. Add connections to your account at: <a href="http://www.heapless.com/account/connections/" target="_blank" class="link">http://www.heapless.com/account/connections/</a>
															<br height="10" />
														</td>
													</tr>
													<tr>
												...
												<br height="10" />
												HeapLess will continue to add more features all the time.
												<br height="20" />
												Enjoy,<br />
												HeapLess
											</td>
				...
				<tr>
					<td class="footer">
						<br height="15" />
						You're receiving this newsletter because you have a Heapless account.<br /> 
						Having trouble reading this email? <a href="#" target="_blank" class="link-2">View it in your browser</a>. Not interested anymore? <a href="#" target="_blank" class="link-2">Click here to unsubscribe</a>
						<br height="15" />
					</td>
				</tr>
				<tr>
